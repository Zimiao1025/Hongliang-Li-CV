...
\newcommand{\CVScholarURL}{https://scholar.google.com/citations?user=Fk49kawAAAAJ\&hl=en\&oi=sra}
\newcommand{\CVCitations}{404}

% Add URLs here when OriBench pages are public.
\newcommand{\OriBenchPlatformURL}{https://oribench.lglab.ac.cn/}
\newcommand{\OriBenchDocsURL}{https://oribench.lglab.ac.cn/docs.html}
...
\project{ScoreBench — All-Modality Affinity Prediction Benchmark}{Benchmark \& Evaluation}
\begin{detailitems}
  \item Constructed a comprehensive affinity-prediction benchmark for all-modality drug systems, spanning small molecules, antibodies, peptides, and other therapeutic modalities.
  \item Organized the benchmark around three practical task families: \textbf{binding} assessment, affinity \textbf{optimization}, and mutation-effect prediction, with standardized data, evaluation protocols, and metrics for consistent comparison.
  \item Conducted broad evaluations of frontier large language models, including \textbf{Claude, GPT, Kimi, and DeepSeek}, to characterize their capabilities across drug modalities and affinity-related tasks.
  \item Performed task- and modality-level error analysis to identify recurring LLM failure modes, robustness gaps, and limitations in molecular reasoning and quantitative affinity prediction.
\end{detailitems}
...
\noindent\hfill{\small\textit{Total citations: \textbf{\CVCitations}}}\par
\vspace{0.12em}
...
\publication{\textbf{Hongliang Li} and Bin Liu. (2023). ``BioSeq-Diabolo: Biological Sequence Similarity Analysis Using Diabolo Embeddings.'' \textit{PLOS Computational Biology}, 19(6), e1011214.}

\publication{\textbf{Hongliang Li}, Yihe Pang, and Bin Liu. (2022). ``BioSeq-BLM: A Comprehensive Platform for Analyzing DNA, RNA, and Protein Sequences Based on Biological Language Models.'' \textit{Nucleic Acids Research}, 49(22), e129.}

\publication{Qilong Wang, Huikun Zeng, Yan Zhu, \textbf{Hongliang Li}, et al. (2021). ``Dual UMIs and Dual Barcodes With Minimal PCR Amplification Removes Artifacts and Acquires Accurate Antibody Repertoires.'' \textit{Frontiers in Immunology}, 12, 778298.}
